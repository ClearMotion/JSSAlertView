...
open class JSSAlertView: UIViewController {
	...
	@discardableResult
	open func info(_ viewController: UIViewController, title: String, text: String? = nil, buttonText: String? = nil, cancelButtonText: String? = nil, color: UIColor?=UIColorFromHex(0x3498db, alpha: 1), delay: Double? = nil) -> JSSAlertViewResponder {
		let alertview = show(viewController, title: title, text: text, buttonText: buttonText, cancelButtonText: cancelButtonText, color: color, delay: delay)
